package com.seven.mybatispluseasyexcel.normal.aspect;
...
public class DurationAspect {
    ...
    @Around("execution(public void com.seven.mybatispluseasyexcel.normal.controller.SalariesController.exportExcel*(..))")
    ...
    @Around("execution(public void com.seven.mybatispluseasyexcel.normal.controller.SalariesController.importExcel*(..))")
